...
def main():
    ...
    net = MnistNeuralNetwork(layer_sizes=MNIST_NN_LAYERS, activation_function=NeuralNetwork.sigmoid, epochs=30,
                             minimalization_algorithm=TrainingAlgorithm.BGD, learning_rate=2)
